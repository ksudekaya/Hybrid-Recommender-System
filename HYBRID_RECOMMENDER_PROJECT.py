...
# Veri setinin %10'unu örnekleyin
common_movies_sample = common_movies.sample(frac=0.001)
...
#er kullanıcının hangi filme kaç puan verdiğini gösteren bir pivot tablo (kullanıcı-film matrisi) oluşturu
#############################################
